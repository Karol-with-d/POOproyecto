 ...
 */
export default function BuildItStartPage() {
  ...
  return (
    ...
    >
      ...
      <main className="w-full max-w-3xl flex-1 flex flex-col items-center justify-center mt-20 relative z-20 px-5">
        ...
        >
          <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#bfe5fe] opacity-50 rounded-full blur-3xl pointer-events-none"></div>
          <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-[#ccebc7] opacity-40 rounded-full blur-3xl pointer-events-none"></div>
